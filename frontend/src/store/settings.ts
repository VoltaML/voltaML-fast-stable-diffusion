  ...
  const scheduler_options: SelectMixedOption[] = [
    {
      ...
      children: [
        ...
        { label: "Borked: Euler", value: "Euler" },
        { label: "Borked: LMS", value: "LMS" },
        { label: "Borked: Heun", value: "Heun" },
        { label: "Borked: DPM Fast", value: "DPM fast" },
        { label: "Borked: DPM Adaptive", value: "DPM adaptive" },
        { label: "Borked: DPM2", value: "DPM2" },
        { label: "DPM2 a", value: "DPM2 a" },
        { label: "DPM++ 2S a", value: "DPM++ 2S a" },
        { label: "Borked: DPM++ 2M", value: "DPM++ 2M" },
        { label: "Borked: DPM++ 2M Sharp", value: "DPM++ 2M Sharp" },
