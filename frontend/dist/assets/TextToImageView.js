...
const _hoisted_30 = /* @__PURE__ */ createBaseVNode(
  "p",
  { style: { "margin-right": "12px", width: "75px" } },
  "Seed",
  -1
);
...
const _hoisted_39 = { class: "flex-container" };
...
const _hoisted_41 = { class: "flex-container" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isSelectedModelPyTorch = computed(() => {
      var _a;
      return (
        ((_a = conf.data.settings.model) == null ? void 0 : _a.backend) ===
        "PyTorch"
      );
    });
                            ...
                            },
                            {
                              default: withCtx(() => [
                                createVNode(
                                  ...
                                  {
                                    value:
                                      unref(conf).data.settings.txt2img.prompt,
                                    "onUpdate:value":
                                      _cache[0] ||
                                      (_cache[0] = ($event) =>
                                        (unref(
                                          conf
                                        ).data.settings.txt2img.prompt =
                                          $event)),
                                    type: "textarea",
                                    placeholder: "Prompt",
                                    "show-count": "",
                                  ...
                                  unref(NInput),
                                  {
                                    ...
                                    "onUpdate:value":
                                      ...
                                      (_cache[2] = ($event) =>
                                        (unref(
                                          conf
                                        ).data.settings.txt2img.negative_prompt =
                                          $event)),
                                    type: "textarea",
                                ...
                                createBaseVNode("div", _hoisted_14, [
                                  ...
                                  createVNode(
                                    ...
                                    {
                                      value:
                                        unref(conf).data.settings.txt2img.steps,
                                      "onUpdate:value":
                                        _cache[9] ||
                                        (_cache[9] = ($event) =>
                                          (unref(
                                            conf
                                          ).data.settings.txt2img.steps =
                                            $event)),
                                      min: 5,
                                      max: 300,
                                      style: { "margin-right": "12px" },
                                    ...
                                    unref(NSlider),
                                    {
                                      ...
                                      "onUpdate:value":
                                        ...
                                        (_cache[11] = ($event) =>
                                          (unref(
                                            conf
                                          ).data.settings.txt2img.cfg_scale =
                                            $event)),
                                      min: 1,
                                      max: 30,
                                      step: 0.5,
                                    ...
                                    unref(NSlider),
                                    {
                                      ...
                                      "onUpdate:value":
                                        ...
                                        (_cache[15] = ($event) =>
                                          (unref(
                                            conf
                                          ).data.settings.txt2img.batch_count =
                                            $event)),
                                      min: 1,
                                      max: 9,
                                      style: { "margin-right": "12px" },
                                ...
                                unref(conf).data.settings.aitDim.batch_size
                                  ? (openBlock(),
                                  ...
                                  : (openBlock(),
                                    createElementBlock("div", _hoisted_27, [
                                      createVNode(
                                        unref(NTooltip),
                                        { style: { "max-width": "600px" } },
                                        {
                                          trigger: withCtx(() => [_hoisted_28]),
                                          default: withCtx(() => [
                                            createTextVNode(
                                              " Number of images to generate in paralel. "
                                            ),
                                        ...
                                        unref(NSlider),
                                        {
                                          ...
                                          "onUpdate:value":
                                            ...
                                            (_cache[17] = ($event) =>
                                              (unref(
                                                conf
                                              ).data.settings.txt2img.batch_size =
                                                $event)),
                                          min: 1,
                                          max: 9,
                                          style: { "margin-right": "12px" },
                                ...
                                createBaseVNode("div", _hoisted_29, [
                                  ...
                                  createVNode(
                                    ...
                                    {
                                      value:
                                        unref(conf).data.settings.txt2img.seed,
                                      "onUpdate:value":
                                        _cache[19] ||
                                        (_cache[19] = ($event) =>
                                          (unref(
                                            conf
                                          ).data.settings.txt2img.seed =
                                            $event)),
                                      size: "small",
                                      min: -1,
                                      max: 999999999999,
                            ...
                            createVNode(
                              unref(NSwitch),
                              {
                                ...
                                "onUpdate:value":
                                  _cache[20] ||
                                  (_cache[20] = ($event) =>
                                    (unref(global).state.txt2img.highres =
                                      $event)),
                                  ...
                                  default: withCtx(() => [
                                    createBaseVNode("div", _hoisted_34, [
                                      ...
                                      createVNode(
                                        ...
                                        {
                                          value:
                                            unref(conf).data.settings.extra
                                              .highres.steps,
                                          "onUpdate:value":
                                            _cache[21] ||
                                            (_cache[21] = ($event) =>
                                              (unref(
                                                conf
                                              ).data.settings.extra.highres.steps =
                                                $event)),
                                          min: 5,
                                          max: 300,
                                          style: { "margin-right": "12px" },
                                        ...
                                        unref(NSlider),
                                        {
                                          ...
                                          "onUpdate:value":
                                            ...
                                            (_cache[23] = ($event) =>
                                              (unref(
                                                conf
                                              ).data.settings.extra.highres.scale =
                                                $event)),
                                          min: 1,
                                          max: 8,
                                          step: 1,
                                        ...
                                        unref(NSlider),
                                        {
                                          ...
                                          "onUpdate:value":
                                            ...
                                            (_cache[25] = ($event) =>
                                              (unref(
                                                conf
                                              ).data.settings.extra.highres.strength =
                                                $event)),
                                          min: 0.1,
                                          max: 0.9,
                                          step: 0.05,
                                        ...
                                        unref(NSwitch),
                                        {
                                          ...
                                          "onUpdate:value":
                                            ...
                                            (_cache[27] = ($event) =>
                                              (unref(
                                                conf
                                              ).data.settings.extra.highres.antialiased =
                                                $event)),
                                        },
                                        null,
                                        8,
                                    ...
                                    createBaseVNode("div", _hoisted_43, [
                                      ...
                                      createVNode(
                                        unref(NSelect),
                                        {
                                          value:
                                            unref(conf).data.settings.extra
                                              .highres.latent_scale_mode,
                                          "onUpdate:value":
                                            _cache[28] ||
                                            (_cache[28] = ($event) =>
                                              (unref(
                                                conf
                                              ).data.settings.extra.highres.latent_scale_mode =
                                                $event)),
                                          size: "small",
                                          style: { "flex-grow": "1" },
                                          options: [
                ...
                createVNode(unref(NGi), null, {
                  default: withCtx(() => [
                    ...
                    createVNode(
                      ...
                      {
                        "current-image":
                          unref(global).state.txt2img.currentImage,
