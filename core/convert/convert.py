    ...
    if attention_paths_to_split is not None:
        for path, path_map in attention_paths_to_split.items():
            ...
            if config is not None:
                ...
                raise ValueError("num_head_channels was not found in config")
...
def convert_ldm_clip_checkpoint(checkpoint):
    ...
    text_model.load_state_dict(text_model_dict)  # type: ignore
...
def convert_open_clip_checkpoint(checkpoint):
    ...
    ] = text_model.text_model.embeddings.get_buffer(  # type: ignore
        "position_ids"
    )
...
if __name__ == "__main__":
        ...
        if key_name in checkpoint and checkpoint[key_name].shape[-1] == 1024:
            if not os.path.isfile("v2-inference-v.yaml"):
                ...
                os.system(
                    ...
                    " -O v2-inference-v.yaml --no-check-certificate"
                )
            ...
            if not os.path.isfile("v1-inference.yaml"):
                ...
                with open("v1-inference.yaml", "w") as f:
                    f.write(r.text)
    ...
    if model_type == "FrozenOpenCLIPEmbedder":
        print("Using FrozenOpenCLIPEmbedder")
